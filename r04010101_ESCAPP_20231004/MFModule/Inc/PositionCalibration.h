...
#define ROTATE_STEPS_WHEN_LINEARIZATION 100
...
typedef enum
{
	...
	PS_CALI_ZERO_SM_POSITIONING_MECH_ZERO,
...
typedef enum
{
	...
	PS_CALI_LINEAR_SM_POSITIONING_MECH_ZERO,
...
typedef enum
{
	PS_CALI_MANUAL_LINEAR_SM_NONE = 0,
	PS_CALI_MANUAL_LINEAR_SM_ROTATE_TO_ZERO,
	PS_CALI_MANUAL_LINEAR_SM_POSITIONING,
	PS_CALI_MANUAL_LINEAR_SM_ROTATING,
	PS_CALI_MANUAL_LINEAR_SM_FINISHED,
	PS_CALI_MANUAL_LINEAR_SM_ERROR
}PS_CALI_MANUAL_LINEAR_SM_e;
...
typedef struct
{
	...
	PS_CALI_MANUAL_LINEAR_SM_e Manual_Linear_State;
