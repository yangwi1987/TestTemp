...
typedef enum
{
	PS_CALI__LINEAR_SM_NONE = 0,
	PS_CALI__LINEAR_SM_FIND_MECH_ZERO,
	PS_CALI__LINEAR_SM_FIND_POINTS,
	PS_CALI__LINEAR_SM_SEND_RESULT,
	PS_CALI__LINEAR_SM_FINISHED,
	PS_CALI__LINEAR_SM_ERROR
}PS_CALI__LINEAR_SM_e;
...
typedef struct
{
	...
	PS_CALI__LINEAR_SM_e _Linear_State;
