...
__attribute__((__section__(".SystemBin"),used)) const System_Table_t_Linker SystemTable =
{
		...
		{		// 0x00 ~ 0x0F
				...
				{ALARMID_CAN1_TIMEOUT, 			ALARM_DISABLE, ALARM_TYPE_NONCRITICAL, TRIG_MODE_HIGH,  10, 	ALARM_COUNTER_MAX, 100},
				...
				// 0x40 ~ 0x4F
				{ALARMID_MOTORSTALL, ALARM_DISABLE, ALARM_TYPE_CRITICAL, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNDER_VOLTAGE_BUS_WARNING, ALARM_DISABLE, 	ALARM_TYPE_NONCRITICAL,   TRIG_MODE_LOW,   45,    ALARM_COUNTER_MAX, 10},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
