...
__attribute__((__section__(".SystemBin"),used)) const System_Table_t_Linker SystemTable =
{
		...
		{		// 0x00 ~ 0x0F
				...
				// 0x20 ~ 0x2F
				{ALARMID_TOTAL_TIME_NULL,       ALARM_ENABLE, ALARM_TYPE_NONCRITICAL, TRIG_MODE_HIGH,  0, ALARM_COUNTER_MAX, 0},
				{ALARMID_CURR_CAL_BACKUP_NULL,  ALARM_ENABLE, ALARM_TYPE_NONCRITICAL, TRIG_MODE_HIGH,  0, ALARM_COUNTER_MAX, 0},
