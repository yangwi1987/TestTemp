...
__attribute__((__section__(".SystemBin"),used)) const System_Table_t_Linker SystemTable =
{
		...
		{		// 0x00 ~ 0x0F
				...
				{ALARMID_CAN1_TIMEOUT, 			ALARM_ENABLE,  	ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  0, 	100, ALARM_COUNTER_MAX},
				...
				{ALARMID_BREAK_NTC_PCU_0, 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  3900, 10, 	ALARM_COUNTER_MAX},
				{ALARMID_SHORT_NTC_PCU_0, 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_LOW,   120,  10, 	ALARM_COUNTER_MAX},
				{ALARMID_OT_PCU_1, 		 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  120,   5, 	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_PCU_1, 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  3900, 10, 	ALARM_COUNTER_MAX},
				{ALARMID_SHORT_NTC_PCU_1, 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_LOW,   120,  10, 	ALARM_COUNTER_MAX},
				{ALARMID_OT_PCU_2, 			ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  115,  5,  	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_PCU_2, 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  4065, 10, 	ALARM_COUNTER_MAX},
				{ALARMID_SHORT_NTC_PCU_2, 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_LOW,   100,  10, 	ALARM_COUNTER_MAX},
#if IS_MF_CODE_BIN_FILE
				...
				{ALARMID_BREAK_NTC_MOTOR_0, ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  4075, 10, 	ALARM_COUNTER_MAX},
				{ALARMID_SHORT_NTC_MOTOR_0, ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_LOW,   200,  10, 	ALARM_COUNTER_MAX},
#endif
				{ALARMID_UNUSED, 			ALARM_DISABLE, ALARM_TYPE_NONE,  TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, 			ALARM_DISABLE, ALARM_TYPE_NONE,  TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, 			ALARM_DISABLE, ALARM_TYPE_NONE,  TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
