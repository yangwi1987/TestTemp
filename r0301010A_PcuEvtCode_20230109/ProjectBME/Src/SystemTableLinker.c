...
__attribute__((__section__(".SystemBin"),used)) const System_Table_t_Linker SystemTable =
{
		...
		.SysParamTableInfoArray =
		{
				...
				{		0,		 10000,		    5,		 0x5A,		&DriveParams.SystemParams.ThrottleRiseRamp[0]},	//P1-19
				{		0,		 10000,		    5,		 0x5A,		&DriveParams.SystemParams.ThrottleRiseRamp[1]},	//P1-20
				{		0,		 10000,		    5,		 0x5A,		&DriveParams.SystemParams.ThrottleRiseRamp[2]},	//P1-21
				{		0,		 10000,			5,		 0x5A,		&DriveParams.SystemParams.ThrottleRiseRamp[3]},	//P1-22
				{		0,		 10000,			5,		 0x5A,		&DriveParams.SystemParams.ThrottleRiseRamp[4]},	//P1-23
				{		1,		 10000,			10000,		 0x5A,		&DriveParams.SystemParams.ThrottleFallRamp},	//P1-24
