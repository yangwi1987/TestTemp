...
__attribute__((__section__(".SystemBin"),used)) const System_Table_t_Linker SystemTable =
{
		...
		// When use AlarmDetect_Accumulation, Alarm type depending on ErrorCounter or WarningCounter.
		.AlarmTableInfo = \
		{		// 0x00 ~ 0x0F
				...
				{ALARMID_CAN1_TIMEOUT, 			ALARM_ENABLE,  	ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  0, 	ALARM_COUNTER_MAX, 100},
#if IS_MF_CODE_BIN_FILE
				{ALARMID_PSB1_COMM_FAIL, 		ALARM_DISABLE, 	ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_PSB_WRONG_CHECKSUM,	ALARM_DISABLE, 	ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#elif BME
				{ALARMID_UNUSED, 				ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, 				ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#endif
				...
				{ALARMID_UNUSED, 				ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				// 0x10 ~ 0x1F
				{ALARMID_POWER_TRANSISTOR_OC, 	ALARM_ENABLE, ALARM_TYPE_ERROR, TRIG_MODE_HIGH, ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_BUFFER_IC_ERROR, 	  	ALARM_ENABLE, ALARM_TYPE_ERROR,    TRIG_MODE_HIGH, ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#if IS_MF_CODE_BIN_FILE
				{ALARMID_PHASE_LOSS, 	 	  	ALARM_DISABLE, ALARM_TYPE_ERROR,    TRIG_MODE_HIGH, ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#elif BME&EVT
				{ALARMID_PHASE_LOSS, 	 	  	ALARM_ENABLE, ALARM_TYPE_ERROR,    TRIG_MODE_HIGH, ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#endif
				{ALARMID_MOTOR_OVER_SPEED, 	  ALARM_ENABLE, ALARM_TYPE_ERROR, 	 TRIG_MODE_HIGH, 8000, 100, ALARM_COUNTER_MAX},
				{ALARMID_OVER_VOLTAGE_BUS, 	  ALARM_ENABLE, ALARM_TYPE_ERROR, 	 TRIG_MODE_HIGH, 62,   10, ALARM_COUNTER_MAX},
				{ALARMID_UNDER_VOLTAGE_BUS,   	ALARM_ENABLE, 	ALARM_TYPE_ERROR,   TRIG_MODE_LOW,   36,    10, ALARM_COUNTER_MAX},
				{ALARMID_UNDER_VOLTAGE_13V,   	ALARM_ENABLE, 	ALARM_TYPE_ERROR, 	TRIG_MODE_LOW,   10,    10, ALARM_COUNTER_MAX},
				{ALARMID_IU_OCP, 			  	ALARM_DISABLE,	ALARM_TYPE_ERROR, 	TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_IV_OCP, 			  	ALARM_DISABLE, 	ALARM_TYPE_ERROR, 	TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_IW_OCP, 		  	  	ALARM_DISABLE, 	ALARM_TYPE_ERROR, 	TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_FLASH_UNINITIALIZED, ALARM_ENABLE, ALARM_TYPE_ERROR,    TRIG_MODE_HIGH, 0,		 0, ALARM_COUNTER_MAX},
				{ALARMID_FLASH_READ_FAILED,   ALARM_ENABLE, ALARM_TYPE_ERROR,    TRIG_MODE_HIGH, 0,		 0, ALARM_COUNTER_MAX},
				{ALARMID_FLASH_DAMAGED,   	  ALARM_ENABLE, ALARM_TYPE_ERROR,    TRIG_MODE_HIGH, 0,		 0, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, 				ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, 				ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, 				ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				// 0x20 ~ 0x2F
				...
				{ALARMID_FOIL_BREAK, ALARM_ENABLE, ALARM_TYPE_WARNING, TRIG_MODE_LOW,  125, ALARM_COUNTER_MAX, 10},
				{ALARMID_FOIL_SHORT, ALARM_ENABLE, ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  4752, ALARM_COUNTER_MAX, 10},
#else
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#endif
				...
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				// 0x30 ~ 0x3F
				{ALARMID_OT_PCU_0, 		 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  120,   5,  	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_PCU_0, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  3900, ALARM_COUNTER_MAX, 	10},
				{ALARMID_SHORT_NTC_PCU_0, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_LOW,   120,  ALARM_COUNTER_MAX, 	10},
				{ALARMID_OT_PCU_1, 		 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  120,   5, 	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_PCU_1, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  3900, ALARM_COUNTER_MAX, 	10},
				{ALARMID_SHORT_NTC_PCU_1, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_LOW,   120,  ALARM_COUNTER_MAX, 	10},
				{ALARMID_OT_PCU_2, 			ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  115,  5,  	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_PCU_2, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  4065, ALARM_COUNTER_MAX, 	10},
				{ALARMID_SHORT_NTC_PCU_2, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_LOW,   100,  ALARM_COUNTER_MAX, 	10},
#if IS_MF_CODE_BIN_FILE
				{ALARMID_OT_MOTOR_0,	 	ALARM_DISABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  180,  5,  	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_MOTOR_0, ALARM_DISABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  4075, 10, 	ALARM_COUNTER_MAX},
				{ALARMID_SHORT_NTC_MOTOR_0, ALARM_DISABLE,  ALARM_TYPE_ERROR, TRIG_MODE_LOW,   200,  10, 	ALARM_COUNTER_MAX},
#else
				{ALARMID_OT_MOTOR_0,	 	ALARM_ENABLE,  ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  175,  5, 	 	ALARM_COUNTER_MAX},
				{ALARMID_BREAK_NTC_MOTOR_0, ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  4075, ALARM_COUNTER_MAX, 	10},
				{ALARMID_SHORT_NTC_MOTOR_0, ALARM_ENABLE,  ALARM_TYPE_WARNING, TRIG_MODE_LOW,   200,  ALARM_COUNTER_MAX, 	10},
#endif
				{ALARMID_OT_PCU_0_WARNING, 	ALARM_ENABLE, ALARM_TYPE_WARNING,  TRIG_MODE_HIGH,  115, ALARM_COUNTER_MAX, 10},
				{ALARMID_OT_PCU_1_WARNING, 	ALARM_ENABLE, ALARM_TYPE_WARNING,  TRIG_MODE_HIGH,  115, ALARM_COUNTER_MAX, 10},
				{ALARMID_OT_PCU_2_WARNING, 	ALARM_ENABLE, ALARM_TYPE_WARNING,  TRIG_MODE_HIGH,  110, ALARM_COUNTER_MAX, 10},
				{ALARMID_OT_MOTOR_0_WARNING,ALARM_ENABLE, ALARM_TYPE_WARNING,  TRIG_MODE_HIGH,  170, ALARM_COUNTER_MAX, 10},
				// 0x40 ~ 0x4F
				{ALARMID_MOTORSTALL, ALARM_ENABLE, ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				...
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_RC_INVALID, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, 	TRIG_MODE_HIGH,  9, ALARM_COUNTER_MAX, 3},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				...
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				// 0x70 ~ 0x7F
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_ERROR, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
		...
		.SysParamTableInfoArray =
		{
				...
				{		32768,		62768,		35768,		0x84A,		&DriveParams.SystemParams.LimpRisingRamp},	//P0-87
				{		2768,		32768,		29768,		0x84A,		&DriveParams.SystemParams.LimpFallingRamp},	//P0-88
				{		0,			0,			0,			0,		0},	//P0-89
				{		0,			0,			0,			0,		0},	//P0-90
				{		0,			0,			0,			0,		0},	//P0-91
