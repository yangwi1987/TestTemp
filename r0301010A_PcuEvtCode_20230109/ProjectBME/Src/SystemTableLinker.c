...
__attribute__((__section__(".SystemBin"),used)) const System_Table_t_Linker SystemTable =
{
		...
		{		// 0x00 ~ 0x0F
				...
				{ALARMID_FLASH_UNINITIALIZED, ALARM_ENABLE, ALARM_TYPE_WARNING,    TRIG_MODE_HIGH, 0,		 0, ALARM_COUNTER_MAX},
				...
				{ALARMID_FOIL_BREAK, ALARM_ENABLE, ALARM_TYPE_WARNING, TRIG_MODE_LOW,  BREAK_FOIL_ADC, ALARM_COUNTER_MAX, 10},
				{ALARMID_FOIL_SHORT, ALARM_ENABLE, ALARM_TYPE_WARNING, TRIG_MODE_HIGH,  SHORT_FOIL_ADC, ALARM_COUNTER_MAX, 10},
#else
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
#endif
				...
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
//				{ALARMID_RC_ABNORMAL, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, 	TRIG_MODE_HIGH,  20, ALARM_COUNTER_MAX, 20},
				{ALARMID_RC_ABNORMAL, 	ALARM_ENABLE,  ALARM_TYPE_WARNING, 	TRIG_MODE_HIGH,  9, ALARM_COUNTER_MAX, 3},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
				{ALARMID_UNUSED, ALARM_DISABLE, ALARM_TYPE_NONE, TRIG_MODE_HIGH,  ALARM_THRESHOLD_MAX, ALARM_COUNTER_MAX, ALARM_COUNTER_MAX},
